                        ...
                        <div class="p-30">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        autocomplete="current-password"  data-strength class="form-control pl-15 bg-transparent text-black plc-white" >
                                    </div>
...
<script type="text/javascript">
    function signupUser(){
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url()."account/doregister";?>', //includes/login_signup_codes.php
            data:{'req':'signup_code','fn':fullname,'un':username,'em':emailAdd,'pd':password,'cpd':cpassword,'gr':gender,'recaptchaResponses':recaptchaResponses,'phone_code':phone_code},
            beforeSend:function(){
                $('.btn-rounded').hide();
