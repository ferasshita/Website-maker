...
public function __construct(){
		...
		$this->load->helper(
			array('langs', 'IsLogedin', 'Phonecodes','Sendmail','Sendsms','emailBody','functions_zone')
		);
...
//=======================[cookie]===================================
	...
	$encryption = openssl_encrypt(${"var".$postsfetchi->name}, $ciphering, $encryption_key, $options, $encryption_iv);
...
if(project_settings('captcha') != "captcha"){
	...
	$checkkey = "6LdW8-wcAAAAAJhg4nil5w5FYjy4VM0GvnIstGeA";
