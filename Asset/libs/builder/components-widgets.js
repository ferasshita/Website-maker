...
Vvveb.ComponentsGroup['Widgets'] = ["widgets/include", "widgets/googlemaps", "widgets/embed-video", "widgets/chartjs",/* "widgets/facebookpage", */"widgets/paypal", /*"widgets/instagram",*/ "widgets/twitter", "widgets/openstreetmap"/*, "widgets/facebookcomments"*/];

Vvveb.Components.extend("_base", "widgets/include", {
	name: "include",
	attributes: ["data-component-include"],
	image: "icons/product.svg",
	dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.svg">',
	html: '<div id data-component-include><?php $this->load->view(\'includes/mode\'); ?></div>',
